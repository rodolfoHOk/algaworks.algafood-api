...
public class FormaPagamentoController implements FormaPagamentoControllerOpenApi {
	...
	public ResponseEntity<CollectionModel<FormaPagamentoModel>> listar(ServletWebRequest request) {
		...
		CollectionModel<FormaPagamentoModel> formasPagamento = formaPagamentoModelAssembler
	...
	public ResponseEntity<FormaPagamentoModel> buscar(@PathVariable Long formaPagamentoId, ServletWebRequest request) {
		...
		OffsetDateTime dataAtualizacao = formaPagamentoRepository.getDataAtualizacao(formaPagamentoId);
		...
		FormaPagamentoModel formaPagamento = formaPagamentoModelAssembler
				.toModel(cadastroFormaPagamento.buscar(formaPagamentoId));
	...
	public FormaPagamentoModel adicionar(@RequestBody @Valid FormaPagamentoInput formaPagamentoInput) {
		System.out.println(formaPagamentoInput);
