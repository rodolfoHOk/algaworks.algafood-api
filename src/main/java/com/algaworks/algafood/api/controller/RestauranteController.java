...
//				.header(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN, "http://localhost:8000") // liberando acesso cors para o endereço
				.header(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN, "*") // liberando acesso cors para todos
