...
public class RestauranteBasicoModelAssembler 
	...
	public RestauranteBasicoModel toModel(Restaurante restaurante) {
		...
		if (algaSecurity.podeConsultarCozinhas())
			restauranteBasicoModel.getCozinha().add(algaLinks
					.linkToCozinha(restauranteBasicoModel.getCozinha().getId()));
	...
	public CollectionModel<RestauranteBasicoModel> toCollectionModel(Iterable<? extends Restaurante> entities) {
		CollectionModel<RestauranteBasicoModel> restaurantesModel = super.toCollectionModel(entities);
				
		if (algaSecurity.podeConsultarRestaurantes())
			restaurantesModel.add(algaLinks.linkToRestaurantes());
