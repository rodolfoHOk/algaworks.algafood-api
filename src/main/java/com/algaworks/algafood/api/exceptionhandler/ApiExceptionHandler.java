...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleAccessDenied(AccessDeniedException ex, WebRequest request) {
		...
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage("Vocẽ não possui permissão para executar esta operação.")
				.build();
	...
	public ResponseEntity<?> handleValidacao(ValidacaoException ex, WebRequest request) {
		...
		Problem problem = createProblemWithBindingResults(ex.getBindingResult(), status);
	...
	private Problem createProblemWithBindingResults(BindingResult bindingResult, HttpStatusCode status) {
